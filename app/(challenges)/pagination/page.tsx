    ...
    return (
        <div className="h-screen flex justify-center items-center flex-col">
          ...
          <div className="mt-5 flex flex-col gap-2">
              <Link href="https://github.com/atanas-zlatev-98/coding-challenges/blob/master/app/(challenges)/pagination/page.tsx" className="bg-blue-500 hover:bg-blue-700 text-white px-4 py-2 rounded text-center">GitHub Link</Link>
